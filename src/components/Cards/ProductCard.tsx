...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="bg-slate-100 border rounded-lg transition-all duration-200 hover:shadow-lg hover:scale-105 lg:w-[240px]">
      <div className="">
        ...
        <div className="">
          <div className="m-3">
            <div className="space-y-2">
              <h2 className="text-container font-medium lg:text-lg" title={product.name}>
                {product.name}
              </h2>
            ...
            <div>
              <Sheet>
                <SheetTrigger asChild>
                  <button
                    className={cn(buttonVariants(), 'mt-5 w-full bg-purple-600 hover:bg-purple-900 group')}
                    onClick={() => handleAddToCart(product)}
                  >
                    Add to cart
                    <ShoppingCart
                      className="inline-block ml-2 transition-all duration-300 group-hover:translate-x-4 group-hover:text-amber-600"
                      size={16}
                    />
                  </button>
                </SheetTrigger>
